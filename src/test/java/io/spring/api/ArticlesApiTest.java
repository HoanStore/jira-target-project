...
// @generated-by jira-dev-pipeline
  // @generated-ticket Article

  @Test
  public void shouldDownloadExportArticlesExcel() {
    byte[] workbook = "xlsx".getBytes(StandardCharsets.UTF_8);

    when(articleQueryService.exportArticlesExcel(eq(null), eq(null), eq(null), eq(user))).thenReturn(workbook);
    ...
    verify(articleQueryService).exportArticlesExcel(eq(null), eq(null), eq(null), eq(user));
  }
